...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure=px.bar(average_sales, 
                x='Vehicle_Type',
                y='Automobile Sales',
                title="Average Automobile Sales fluctuation over Vehicle_Type"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rate = recession_data.groupby('Unemployment_Rate')['Vehicle_Type']
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp_rate,
                x='Unemployment_Rate',
                y='Vehicle_Type',
                title="Effect of unemployment rate in vehicle type and sales"
                )
        )
        return [
